...
public class AnySimpleTypeTypeInfoCompiler<T, C extends T, O> extends BuiltinLeafInfoCompiler<T, C, O> {

	public AnySimpleTypeTypeInfoCompiler(String name,QName qualifiedName) {
